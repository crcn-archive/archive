...
package com.bridge.module.component
{
	...
	internal class ComponentBuilder
	{
		...
		public function ComponentBuilder(node:BridgeNode = null)
		{
			if(node != null)
			{
				build(node);
		...
		public function build(node:BridgeNode):void
		{
			node.pause();
		...
		private function init():void
		{
			...
			_def.gcWhen = _node.attributes["gcWhen"];
		...
		private function handleConstructor(xml:BridgeNode):void
		{
			var attr:Object;
			var params:Array = new Array();
			
			//go through each of the contructor parameters and assign the default params and values
			for each(var param:BridgeNode in xml.childNodes)
			{
		...
		private function handleProperty(xml:BridgeNode):void
		{
		...
		private function handleHandler(xml:BridgeNode):void
		{
			var attr:Object = xml.attributes;
